...
class hotelViewAdams extends StatefulWidget {
  hotelViewAdams({Key? key, required this.hoteladms}) : super(key: key);
  final Hoteladms hoteladms;

  @override
  State<hotelViewAdams> createState() => _hotelViewAdamsState();
}

class _hotelViewAdamsState extends State<hotelViewAdams> {
  @override
  Widget build(BuildContext context) {
    test testcall = test();

    String? rating = widget.hoteladms.rating;
    String? number = widget.hoteladms.contact;
    String? locationUrl = widget.hoteladms.locationUrl;
    print(number);
